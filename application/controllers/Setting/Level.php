...
// class Registrasi extends Core {
	...
	//VARIABEL
	private $master_tabel="level"; //Mendefinisikan Nama Tabel
	private $id="level_id";	//Menedefinisaikan Nama Id Tabel
	private $default_url="Setting/Level/"; //Mendefinisikan url controller
	private $default_view="Setting/Level/"; //Mendefinisiakn defaul view
	...
	private function global_set($data){
		...
		if(isset($data['overwriteview'])){
			...
			$overwriteview="views/Setting/Level/index.php";
			$menu_submenu='level';
		}
		$data=array(
	...
	public function index()
	{
		...
		if($this->input->post('level_nama')){
			...
			$data=array(
				...
				'level_dashboard'=>$this->input->post('level_dashboard'),
			);
			########################################################
			// $file='reg_foto';
			// if($_FILES[$file]['name']){
